...
###设置隐藏层，10个神经元
l1 = add_layer(xs,1,10,n_layer=1,activation_function=tf.nn.relu)##hidden layer
#隐藏层的输入值是x_data,输入大小是1，输出是10
prediction = add_layer(l1,10,1,n_layer=2,activation_function=None)##output layer
